...
export function meta({}: Route.MetaArgs) {
  return [
    ...
    { name: "description", content: "Automatic backups synced to your storage" },
  ];
}
        ...
        <div className="flex flex-col items-center justify-center min-h-[70vh] px-4">
          <div className="text-center max-w-md">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Set up automatic backups that seamlessly sync with your selected storage driver.
              Your data will be safe and always accessible!
            </p>
