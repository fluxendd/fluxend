...
func (r *DatabaseStatsRepository) GetUnusedIndexes() ([]types.UnusedIndex, error) {
	var unusedIndexes []types.UnusedIndex
...
func (r *DatabaseStatsRepository) GetSlowQueries() ([]types.SlowQuery, error) {
	var slowQueries []types.SlowQuery
...
func (r *DatabaseStatsRepository) GetIndexScansPerTable() ([]types.IndexScan, error) {
	var indexScans []types.IndexScan
...
func (r *DatabaseStatsRepository) GetRowCountPerTable() ([]types.TableRowCount, error) {
	var rowCounts []types.TableRowCount
