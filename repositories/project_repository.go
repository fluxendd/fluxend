...
func (r *ProjectRepository) ListForUser(paginationParams utils.PaginationParams, authenticatedUserId uint) ([]models.Organization, error) {
...
func (r *ProjectRepository) GetByIDForUser(id, authenticatedUserId uint) (models.Organization, error) {
...
func (r *ProjectRepository) Create(organization *models.Organization, authenticatedUserId uint) (*models.Organization, error) {
	tx, err := r.db.Beginx()
	if err != nil {
...
func (r *ProjectRepository) Update(id uint, organization *models.Organization) (*models.Organization, error) {
