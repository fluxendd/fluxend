...
func FormResponseResource(formResponse *form.FormResponse) FormResponseForAPI {
...
func FormResponseResourceCollection(formFields []form.FormResponse) []FormResponseForAPI {
