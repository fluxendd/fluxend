...
func (r *ColumnUpdateRequest) BindAndValidate(c echo.Context) []string {
	...
	err = validation.ValidateStruct(r,
		validation.Field(&r.Name, validation.Required.Error("name: existing name of column is required")),
		validation.Field(&r.Column, validation.Required.Error("column: new definition of column is required")),
	)
